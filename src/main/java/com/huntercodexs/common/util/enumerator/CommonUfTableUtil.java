...
public enum CommonUfTableUtil {
    ...
    CommonUfTableUtil(int ufCode, String stateName, String stateNameClear, String rgsSsp) {
        this.ufCode = ufCode;
    ...
    * */
    public static int ufCode(String uf) {
        return CommonUfTableUtil.valueOf(uf).getUfCode();
    }
    ...
    * */
    public static String stateName(String uf) {
        return CommonUfTableUtil.valueOf(uf).getStateName();
    }
    ...
    * */
    public static String stateNameClear(String uf) {
        return CommonUfTableUtil.valueOf(uf).getStateNameClear();
    }
    ...
    * */
    public static String rgSspCode(String uf) {
        return CommonUfTableUtil.valueOf(uf).getRgsSsp();
    }
    ...
    * */
    public static boolean checkUfExists(String uf) {
        for (CommonUfTableUtil value : CommonUfTableUtil.values()) {
