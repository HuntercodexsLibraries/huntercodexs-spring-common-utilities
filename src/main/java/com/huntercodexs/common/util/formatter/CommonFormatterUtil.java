...
import com.huntercodexs.common.util.enumerator.CommonUfTableUtil;
...
public class CommonFormatterUtil {
    ...
    * */
    public static String rgFormatter(String value, String rgUf, boolean rgPrefix) {
        ...
        if (!CommonUfTableUtil.checkUfExists(rgUf) && !CommonUfTableUtil.checkRgSspExists(rgUf)) {
            rgUf = "";
        }
