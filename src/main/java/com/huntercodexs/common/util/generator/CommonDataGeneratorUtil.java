...
import static com.huntercodexs.common.util.basic.CommonsToolsBasicUtil.md5;
import static com.huntercodexs.common.util.currency.CommonCurrencyUtil.*;

public class CommonDataGeneratorUtil {
    ...
    * */
    ...
    /**
     * <h6 style="color: #FFFF00; font-size: 11px">randomNumberGenerate</h6>
     *
     * <p style="color: #CDCDCD">Generate a random number with a specified number of digits given in the parameters</p>
     *
     * @param digits (int: Quantities of digits to generate random number)
     * @return int (Random Number)
     * */
    public static int randomNumberGenerate(int digits) {
        String number = UUID.fromString(String.valueOf(UUID.randomUUID())).toString().replaceAll("[^0-9]", "");
        if (number.startsWith("0")) {
