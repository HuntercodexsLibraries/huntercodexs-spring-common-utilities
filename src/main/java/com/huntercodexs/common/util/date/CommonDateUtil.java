...
import static com.huntercodexs.common.util.constants.CommonConstantsUtil.PATTERN_DATE_EVENT_FORMAT;
...
public class CommonDateUtil {
    ...
    public static String convertOffsetDateTimeToString(OffsetDateTime offsetDateTime) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern(PATTERN_DATE_EVENT_FORMAT);
        if (nonNull(offsetDateTime))
            return offsetDateTime.atZoneSameInstant(UTC).format(formatter);
        return null;
    }
    ...
    public static String convertDateToString(Date date) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern(PATTERN_DATE_EVENT_FORMAT);
        if (nonNull(date))
            return date.toInstant().atZone(UTC).format(formatter);
        return null;
    }
