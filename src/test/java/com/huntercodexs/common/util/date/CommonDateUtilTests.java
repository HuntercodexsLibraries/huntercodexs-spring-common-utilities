package com.huntercodexs.common.util.date;
...
import static com.huntercodexs.common.util.date.CommonDateUtil.*;
import static org.junit.jupiter.api.Assertions.*;

class CommonDateUtilTests {

    @Test
    public void dateReverseTest() {
        assertEquals("2023-07-14 14:53:25", dateReverse("14/07/2023 14:53:25", "-"));
        assertEquals("16/08/2023 16:10:28", dateReverse("2023-08-16 16:10:28", "/"));
        assertEquals("2023/07/14 14:53:25", dateReverse("14/07/2023 14:53:25", "/"));
        assertEquals("16-08-2023 16:10:28", dateReverse("2023-08-16 16:10:28", "-"));

        assertEquals("2023-07-14 14:53:25", dateReverse("14/07/2023TZ14:53:25", "-"));
        assertEquals("16/08/2023 16:10:28", dateReverse("2023-08-16TZ16:10:28", "/"));
        assertEquals("2023/07/14 14:53:25", dateReverse("14/07/2023TZ14:53:25", "/"));
        assertEquals("16-08-2023 16:10:28", dateReverse("2023-08-16TZ16:10:28", "-"));
        assertEquals("15-08-2023 18:02:26.737", dateReverse("2023-08-15T18:02:26.737Z", "-"));
        assertEquals("15/08/2023 18:02:26.737", dateReverse("2023-08-15T18:02:26.737Z", "/"));

        assertEquals("2023-07-14", dateReverse("14/07/2023", "-"));
        assertEquals("16/08/2023", dateReverse("2023-08-16", "/"));
        assertEquals("2023/07/14", dateReverse("14/07/2023", "/"));
        assertEquals("16-08-2023", dateReverse("2023-08-16", "-"));
    }
    ...
    public void dateExpiredTest() {
        assertTrue(dateExpired("14/07/2023 14:53:25", 1, "nano"));
        assertTrue(dateExpired("14/07/2023 14:53:25", 1, "second"));
        assertTrue(dateExpired("14/07/2023 14:53:25", 1, "minute"));
        assertTrue(dateExpired("14/07/2023 14:53:25", 1, "hour"));
        assertTrue(dateExpired("14/07/2023 14:53:25", 1, "day"));
        assertTrue(dateExpired("14/07/2023 14:53:25", 1, "week"));
        assertTrue(dateExpired("14/07/2023 14:53:25", 1, "month"));

        LocalDateTime now = LocalDateTime.now();
        int year = now.getYear();
        assertFalse(dateExpired("14/07/"+year+" 14:53:25", 1, "year"));
    }
...
//        );
    ...
    public void militaryTimeConversionTest() {
        assertEquals("12:00:00", militaryHour("12:00:00PM"));
        assertEquals("00:00:00", militaryHour("12:00:00AM"));
        assertEquals("06:00:00", militaryHour("06:00:00AM"));
        assertEquals("18:00:00", militaryHour("06:00:00PM"));
        assertEquals("12:24:00", militaryHour("12:24:00PM"));
        assertEquals("00:45:00", militaryHour("12:45:00AM"));
        assertEquals("06:59:00", militaryHour("06:59:00AM"));
        assertEquals("18:30:00", militaryHour("06:30:00PM"));
    }
    ...
    public void stringToCalendarTest() {
        ...
        assertEquals("Mon Jan 01 10:00:00 BRST 1990", result.getTime().toString());
        assertEquals("631195200000", String.valueOf(result.getTimeInMillis()));
    }
    ...
    public void stringToDateTest() {
        ...
        assertEquals("Mon Jan 01 00:00:00 BRST 1990", result.toString());
        assertEquals("631159200000", String.valueOf(result.getTime()));
